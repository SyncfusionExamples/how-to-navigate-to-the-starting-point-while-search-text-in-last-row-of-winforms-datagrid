...
## About the sample
This example illustrates how to navigate to the starting point while search text in last row of [WinForms DataGrid](https://www.syncfusion.com/winforms-ui-controls/datagrid) (SfDataGrid)?
